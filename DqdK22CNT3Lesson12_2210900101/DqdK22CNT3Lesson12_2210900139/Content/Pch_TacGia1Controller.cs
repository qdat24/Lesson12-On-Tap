...
{
    public class Pch_TacGia1Controller : Controller
    {
        ...
        // GET: Pch_TacGia1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Pch_TacGia1/Create
